...
export class KhachHangService {
    ...
    create(khachHang: KhachHang): Observable<EntityResponseType> {
        ...
        return this.http
            .post<KhachHang>(this.resourceUrl, copy, { observe: 'response' })
    ...
    update(khachHang: KhachHang): Observable<EntityResponseType> {
        const copy = this.convert(khachHang);
        return this.http
            .put<KhachHang>(this.resourceUrl, copy, { observe: 'response' })
            .map((res: EntityResponseType) => this.convertResponse(res));
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http
            .get<KhachHang>(`${this.resourceUrl}/${id}`, {
                observe: 'response'
            })
            .map((res: EntityResponseType) => this.convertResponse(res));
    }
