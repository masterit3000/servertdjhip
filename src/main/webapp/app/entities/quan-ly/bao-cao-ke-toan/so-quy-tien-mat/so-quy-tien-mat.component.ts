...
export class SoQuyTienMatComponent implements OnInit {
    ...
    timKiem() {
        ...
        if (this.selectedNhanVien == this.default) {
            ...
            this.ghiNoService
                .baoCao(LOAIHOPDONG.BATHO, this.tungay, this.denngay)
                .subscribe(
            ...
            this.ghiNoService
                .baoCao(LOAIHOPDONG.VAYLAI, this.tungay, this.denngay)
                .subscribe(
                    (res: HttpResponse<GhiNo[]>) => {
            ...
            this.batHoService
                .baoCaoNV(this.tungay, this.denngay, this.selectedNhanVien.id)
                .subscribe(
                    (res: HttpResponse<BatHo[]>) => {
                        this.batHos = res.body;
                        this.batHos.forEach(element => {
