...
export class SoQuyTienMatComponent implements OnInit {
    ...
    timKiem() {
        this.batHoService.quanLyVonKeToan(this.selectedCuaHang.id).subscribe(
        ...
        this.ghiNoService
            .baoCaoKeToan(LOAIHOPDONG.BATHO, this.tungay, this.denngay, this.selectedCuaHang.id)
            .subscribe(
        ...
        this.ghiNoService
            .baoCaoKeToan(LOAIHOPDONG.VAYLAI, this.tungay, this.denngay, this.selectedCuaHang.id)
            .subscribe(
                (res: HttpResponse<GhiNo[]>) => {
        ...
        this.vayLaiService.baoCaoKeToan(this.tungay, this.denngay, 0, this.selectedCuaHang.id).subscribe(
        ...
        this.vayLaiService.baoCaoKeToan(this.tungay, this.denngay, 1, this.selectedCuaHang.id).subscribe(
            (res: HttpResponse<VayLai[]>) => {
        ...
        this.thuChiService.baoCaoKeToan(this.tungay, this.denngay, this.selectedCuaHang.id).subscribe(
            (res: HttpResponse<LichSuDongTien[]>) => {
